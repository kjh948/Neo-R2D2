...
final class RequestHeaders {
    ...
    public RequestHeaders(Uri uri, RawHeaders headers) {
        ...
        HeaderParser.CacheControlHandler handler = new HeaderParser.CacheControlHandler() { // from class: com.koushikdutta.async.http.cache.RequestHeaders.1
            ...
            public void handle(String directive, String parameter) {
                ...
                if (directive.equalsIgnoreCase("max-stale")) {
