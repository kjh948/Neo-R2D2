...
public final class Decoder {
    ...
    */
    public com.google.zxing.common.DecoderResult decode(com.google.zxing.common.BitMatrix r8, java.util.Map<com.google.zxing.DecodeHintType, ?> r9) throws com.google.zxing.ReaderException {
        /*
            r7 = this;
    ...
    private void correctErrors(byte[] codewordBytes, int numDataCodewords) throws ChecksumException {
        ...
        for (int i = 0; i < numCodewords; i++) {
            codewordsInts[i] = codewordBytes[i] & Draft_75.END_OF_FRAME;
        }
