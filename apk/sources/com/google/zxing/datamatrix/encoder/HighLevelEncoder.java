        ...
        if (startpos < msg.length()) {
            ...
            while (startpos + charsProcessed != msg.length()) {
                ...
                if (charsProcessed >= 4) {
                    ...
                    findMinimums(charCounts, intCharCounts, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, mins);
            ...
            int min = findMinimums(charCounts, intCharCounts2, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, mins2);
