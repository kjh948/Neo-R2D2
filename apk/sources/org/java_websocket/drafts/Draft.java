...
public abstract class Draft {
    ...
    public static HandshakeBuilder translateHandshakeHttp(ByteBuffer buf, WebSocket.Role role) throws IncompleteHandshakeException, InvalidHandshakeException {
