...
public class HOGDescriptor {
    ...
    public boolean checkDetectorSize() {
        boolean retVal = checkDetectorSize_0(this.nativeObj);
        return retVal;
    }

    public boolean load(String filename, String objname) {
        boolean retVal = load_0(this.nativeObj, filename, objname);
        return retVal;
    }

    public boolean load(String filename) {
        boolean retVal = load_1(this.nativeObj, filename);
        return retVal;
    }

    public double getWinSigma() {
        double retVal = getWinSigma_0(this.nativeObj);
        return retVal;
    }

    public long getDescriptorSize() {
        long retVal = getDescriptorSize_0(this.nativeObj);
        return retVal;
    }
    ...
    public Size get_winSize() {
        Size retVal = new Size(get_winSize_0(this.nativeObj));
        return retVal;
    }

    public Size get_blockSize() {
        Size retVal = new Size(get_blockSize_0(this.nativeObj));
        return retVal;
    }

    public Size get_blockStride() {
        Size retVal = new Size(get_blockStride_0(this.nativeObj));
        return retVal;
    }

    public Size get_cellSize() {
        Size retVal = new Size(get_cellSize_0(this.nativeObj));
        return retVal;
    }

    public int get_nbins() {
        int retVal = get_nbins_0(this.nativeObj);
        return retVal;
    }

    public int get_derivAperture() {
        int retVal = get_derivAperture_0(this.nativeObj);
        return retVal;
    }

    public double get_winSigma() {
        double retVal = get_winSigma_0(this.nativeObj);
        return retVal;
    }

    public int get_histogramNormType() {
        int retVal = get_histogramNormType_0(this.nativeObj);
        return retVal;
    }

    public double get_L2HysThreshold() {
        double retVal = get_L2HysThreshold_0(this.nativeObj);
        return retVal;
    }

    public boolean get_gammaCorrection() {
        boolean retVal = get_gammaCorrection_0(this.nativeObj);
        return retVal;
    }

    public MatOfFloat get_svmDetector() {
        MatOfFloat retVal = MatOfFloat.fromNativeAddr(get_svmDetector_0(this.nativeObj));
        return retVal;
    }

    public int get_nlevels() {
        int retVal = get_nlevels_0(this.nativeObj);
        return retVal;
    }

    public boolean get_signedGradient() {
        boolean retVal = get_signedGradient_0(this.nativeObj);
        return retVal;
    }
