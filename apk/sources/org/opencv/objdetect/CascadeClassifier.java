...
public class CascadeClassifier {
    ...
    public Size getOriginalWindowSize() {
        Size retVal = new Size(getOriginalWindowSize_0(this.nativeObj));
        return retVal;
    }
    ...
    public boolean isOldFormatCascade() {
        boolean retVal = isOldFormatCascade_0(this.nativeObj);
        return retVal;
    }

    public boolean load(String filename) {
        boolean retVal = load_0(this.nativeObj, filename);
        return retVal;
    }

    public int getFeatureType() {
        int retVal = getFeatureType_0(this.nativeObj);
        return retVal;
    }
