...
public class KalmanFilter {
    ...
    public Mat correct(Mat measurement) {
        Mat retVal = new Mat(correct_0(this.nativeObj, measurement.nativeObj));
        return retVal;
    }

    public Mat predict(Mat control) {
        Mat retVal = new Mat(predict_0(this.nativeObj, control.nativeObj));
        return retVal;
    }

    public Mat predict() {
        Mat retVal = new Mat(predict_1(this.nativeObj));
        return retVal;
    }

    public Mat get_statePre() {
        Mat retVal = new Mat(get_statePre_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_statePost() {
        Mat retVal = new Mat(get_statePost_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_transitionMatrix() {
        Mat retVal = new Mat(get_transitionMatrix_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_controlMatrix() {
        Mat retVal = new Mat(get_controlMatrix_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_measurementMatrix() {
        Mat retVal = new Mat(get_measurementMatrix_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_processNoiseCov() {
        Mat retVal = new Mat(get_processNoiseCov_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_measurementNoiseCov() {
        Mat retVal = new Mat(get_measurementNoiseCov_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_errorCovPre() {
        Mat retVal = new Mat(get_errorCovPre_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_gain() {
        Mat retVal = new Mat(get_gain_0(this.nativeObj));
        return retVal;
    }
    ...
    public Mat get_errorCovPost() {
        Mat retVal = new Mat(get_errorCovPost_0(this.nativeObj));
        return retVal;
    }
