...
public class VideoWriter {
    ...
    public VideoWriter(String filename, int apiPreference, int fourcc, double fps, Size frameSize, boolean isColor) {
        this.nativeObj = VideoWriter_0(filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height, isColor);
    }
    ...
    public boolean open(String filename, int apiPreference, int fourcc, double fps, Size frameSize, boolean isColor) {
        boolean retVal = open_0(this.nativeObj, filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height, isColor);
        return retVal;
    }

    public boolean open(String filename, int apiPreference, int fourcc, double fps, Size frameSize) {
        boolean retVal = open_1(this.nativeObj, filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height);
        return retVal;
    }

    public boolean open(String filename, int fourcc, double fps, Size frameSize, boolean isColor) {
        boolean retVal = open_2(this.nativeObj, filename, fourcc, fps, frameSize.width, frameSize.height, isColor);
        return retVal;
    }

    public boolean open(String filename, int fourcc, double fps, Size frameSize) {
        boolean retVal = open_3(this.nativeObj, filename, fourcc, fps, frameSize.width, frameSize.height);
        return retVal;
    }
