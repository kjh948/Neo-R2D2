...
public class Mat {
    ...
    public Mat adjustROI(int dtop, int dbottom, int dleft, int dright) {
        Mat retVal = new Mat(n_adjustROI(this.nativeObj, dtop, dbottom, dleft, dright));
        return retVal;
    }
    ...
    public int channels() {
        int retVal = n_channels(this.nativeObj);
        return retVal;
    }

    public int checkVector(int elemChannels, int depth, boolean requireContinuous) {
        int retVal = n_checkVector(this.nativeObj, elemChannels, depth, requireContinuous);
        return retVal;
    }

    public int checkVector(int elemChannels, int depth) {
        int retVal = n_checkVector(this.nativeObj, elemChannels, depth);
        return retVal;
    }

    public int checkVector(int elemChannels) {
        int retVal = n_checkVector(this.nativeObj, elemChannels);
        return retVal;
    }

    public Mat clone() {
        Mat retVal = new Mat(n_clone(this.nativeObj));
        return retVal;
    }

    public Mat col(int x) {
        Mat retVal = new Mat(n_col(this.nativeObj, x));
        return retVal;
    }

    public Mat colRange(int startcol, int endcol) {
        Mat retVal = new Mat(n_colRange(this.nativeObj, startcol, endcol));
        return retVal;
    }

    public Mat colRange(Range r) {
        Mat retVal = new Mat(n_colRange(this.nativeObj, r.start, r.end));
        return retVal;
    }

    public int dims() {
        int retVal = n_dims(this.nativeObj);
        return retVal;
    }

    public int cols() {
        int retVal = n_cols(this.nativeObj);
        return retVal;
    }
    ...
    public Mat cross(Mat m) {
        Mat retVal = new Mat(n_cross(this.nativeObj, m.nativeObj));
        return retVal;
    }

    public long dataAddr() {
        long retVal = n_dataAddr(this.nativeObj);
        return retVal;
    }

    public int depth() {
        int retVal = n_depth(this.nativeObj);
        return retVal;
    }

    public Mat diag(int d) {
        Mat retVal = new Mat(n_diag(this.nativeObj, d));
        return retVal;
    }

    public Mat diag() {
        Mat retVal = new Mat(n_diag(this.nativeObj, 0));
        return retVal;
    }
    ...
    public double dot(Mat m) {
        double retVal = n_dot(this.nativeObj, m.nativeObj);
        return retVal;
    }

    public long elemSize() {
        long retVal = n_elemSize(this.nativeObj);
        return retVal;
    }

    public long elemSize1() {
        long retVal = n_elemSize1(this.nativeObj);
        return retVal;
    }

    public boolean empty() {
        boolean retVal = n_empty(this.nativeObj);
        return retVal;
    }
    ...
    public Mat inv(int method) {
        Mat retVal = new Mat(n_inv(this.nativeObj, method));
        return retVal;
    }

    public Mat inv() {
        Mat retVal = new Mat(n_inv(this.nativeObj));
        return retVal;
    }

    public boolean isContinuous() {
        boolean retVal = n_isContinuous(this.nativeObj);
        return retVal;
    }

    public boolean isSubmatrix() {
        boolean retVal = n_isSubmatrix(this.nativeObj);
        return retVal;
    }
    ...
    public Mat mul(Mat m, double scale) {
        Mat retVal = new Mat(n_mul(this.nativeObj, m.nativeObj, scale));
        return retVal;
    }

    public Mat mul(Mat m) {
        Mat retVal = new Mat(n_mul(this.nativeObj, m.nativeObj));
        return retVal;
    }
    ...
    public Mat reshape(int cn, int rows) {
        Mat retVal = new Mat(n_reshape(this.nativeObj, cn, rows));
        return retVal;
    }

    public Mat reshape(int cn) {
        Mat retVal = new Mat(n_reshape(this.nativeObj, cn));
        return retVal;
    }

    public Mat row(int y) {
        Mat retVal = new Mat(n_row(this.nativeObj, y));
        return retVal;
    }

    public Mat rowRange(int startrow, int endrow) {
        Mat retVal = new Mat(n_rowRange(this.nativeObj, startrow, endrow));
        return retVal;
    }

    public Mat rowRange(Range r) {
        Mat retVal = new Mat(n_rowRange(this.nativeObj, r.start, r.end));
        return retVal;
    }

    public int rows() {
        int retVal = n_rows(this.nativeObj);
        return retVal;
    }

    public Mat setTo(Scalar s) {
        Mat retVal = new Mat(n_setTo(this.nativeObj, s.val[0], s.val[1], s.val[2], s.val[3]));
        return retVal;
    }

    public Mat setTo(Scalar value, Mat mask) {
        Mat retVal = new Mat(n_setTo(this.nativeObj, value.val[0], value.val[1], value.val[2], value.val[3], mask.nativeObj));
        return retVal;
    }

    public Mat setTo(Mat value, Mat mask) {
        Mat retVal = new Mat(n_setTo(this.nativeObj, value.nativeObj, mask.nativeObj));
        return retVal;
    }

    public Mat setTo(Mat value) {
        Mat retVal = new Mat(n_setTo(this.nativeObj, value.nativeObj));
        return retVal;
    }

    public Size size() {
        Size retVal = new Size(n_size(this.nativeObj));
        return retVal;
    }

    public long step1(int i) {
        long retVal = n_step1(this.nativeObj, i);
        return retVal;
    }

    public long step1() {
        long retVal = n_step1(this.nativeObj);
        return retVal;
    }

    public Mat submat(int rowStart, int rowEnd, int colStart, int colEnd) {
        Mat retVal = new Mat(n_submat_rr(this.nativeObj, rowStart, rowEnd, colStart, colEnd));
        return retVal;
    }

    public Mat submat(Range rowRange, Range colRange) {
        Mat retVal = new Mat(n_submat_rr(this.nativeObj, rowRange.start, rowRange.end, colRange.start, colRange.end));
        return retVal;
    }

    public Mat submat(Rect roi) {
        Mat retVal = new Mat(n_submat(this.nativeObj, roi.x, roi.y, roi.width, roi.height));
        return retVal;
    }

    public Mat t() {
        Mat retVal = new Mat(n_t(this.nativeObj));
        return retVal;
    }

    public long total() {
        long retVal = n_total(this.nativeObj);
        return retVal;
    }

    public int type() {
        int retVal = n_type(this.nativeObj);
        return retVal;
    }
