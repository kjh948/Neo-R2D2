...
public class Imgproc {
    ...
    public static Mat getAffineTransform(MatOfPoint2f src, MatOfPoint2f dst) {
        Mat retVal = new Mat(getAffineTransform_0(src.nativeObj, dst.nativeObj));
        return retVal;
    }
    ...
    public static Rect boundingRect(MatOfPoint points) {
        Rect retVal = new Rect(boundingRect_0(points.nativeObj));
        return retVal;
    }

    public static RotatedRect fitEllipse(MatOfPoint2f points) {
        RotatedRect retVal = new RotatedRect(fitEllipse_0(points.nativeObj));
        return retVal;
    }

    public static RotatedRect minAreaRect(MatOfPoint2f points) {
        RotatedRect retVal = new RotatedRect(minAreaRect_0(points.nativeObj));
        return retVal;
    }
    ...
    public static boolean isContourConvex(MatOfPoint contour) {
        boolean retVal = isContourConvex_0(contour.nativeObj);
        return retVal;
    }
    ...
    public static double pointPolygonTest(MatOfPoint2f contour, Point pt, boolean measureDist) {
        double retVal = pointPolygonTest_0(contour.nativeObj, pt.x, pt.y, measureDist);
        return retVal;
    }
