...
public class Moments {
    ...
    protected void completeState() {
        ...
        this.mu11 = mu11;
        this.mu02 = mu02;
        this.mu30 = this.m30 - (((3.0d * mu20) + (this.m10 * cx)) * cx);
        double mu112 = mu11 + mu11;
        this.mu21 = (this.m21 - (((this.m01 * cx) + mu112) * cx)) - (cy * mu20);
        this.mu12 = (this.m12 - (((this.m10 * cy) + mu112) * cy)) - (cx * mu02);
        this.mu03 = this.m03 - (((3.0d * mu02) + (this.m01 * cy)) * cy);
