...
public class Subdiv2D {
    ...
    public Point getVertex(int vertex) {
        Point retVal = new Point(getVertex_1(this.nativeObj, vertex));
        return retVal;
    }
    ...
    public int edgeDst(int edge) {
        int retVal = edgeDst_1(this.nativeObj, edge);
        return retVal;
    }
    ...
    public int edgeOrg(int edge) {
        int retVal = edgeOrg_1(this.nativeObj, edge);
        return retVal;
    }

    public int findNearest(Point pt, Point nearestPt) {
        double[] nearestPt_out = new double[2];
        int retVal = findNearest_0(this.nativeObj, pt.x, pt.y, nearestPt_out);
        if (nearestPt != null) {
    ...
    public int findNearest(Point pt) {
        int retVal = findNearest_1(this.nativeObj, pt.x, pt.y);
        return retVal;
    }

    public int getEdge(int edge, int nextEdgeType) {
        int retVal = getEdge_0(this.nativeObj, edge, nextEdgeType);
        return retVal;
    }

    public int insert(Point pt) {
        int retVal = insert_0(this.nativeObj, pt.x, pt.y);
        return retVal;
    }
    ...
    public int locate(Point pt, int[] edge, int[] vertex) {
        ...
        int retVal = locate_0(this.nativeObj, pt.x, pt.y, edge_out, vertex_out);
        if (edge != null) {
    ...
    public int nextEdge(int edge) {
        int retVal = nextEdge_0(this.nativeObj, edge);
        return retVal;
    }

    public int rotateEdge(int edge, int rotate) {
        int retVal = rotateEdge_0(this.nativeObj, edge, rotate);
        return retVal;
    }

    public int symEdge(int edge) {
        int retVal = symEdge_0(this.nativeObj, edge);
        return retVal;
    }
