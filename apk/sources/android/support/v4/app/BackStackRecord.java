...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    @Override // android.support.v4.app.FragmentTransaction
    public void commitNow() throws IllegalAccessException, NoSuchFieldException {
        disallowAddToBackStack();
        this.mManager.execSingleAction(this, false);
    }

    @Override // android.support.v4.app.FragmentTransaction
    public void commitNowAllowingStateLoss() throws IllegalAccessException, NoSuchFieldException {
        disallowAddToBackStack();
    ...
    boolean interactsWith(ArrayList<BackStackRecord> records, int startIndex, int endIndex) {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            Op op = this.mOps.get(opNum);
            int container = op.fragment.mContainerId;
    ...
    void executeOps() throws IllegalAccessException, NoSuchFieldException {
        int numOps = this.mOps.size();
        for (int opNum = 0; opNum < numOps; opNum++) {
            Op op = this.mOps.get(opNum);
    ...
    void executePopOps(boolean moveToState) throws IllegalAccessException, NoSuchFieldException {
