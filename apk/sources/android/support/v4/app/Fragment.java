...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public final FragmentManager getChildFragmentManager() throws IllegalAccessException, NoSuchFieldException {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public LayoutInflater getLayoutInflater(Bundle savedInstanceState) throws IllegalAccessException, NoSuchFieldException {
    ...
    @CallSuper
    public void onCreate(@Nullable Bundle savedInstanceState) throws IllegalAccessException, NoSuchFieldException {
        this.mCalled = true;
    ...
    void restoreChildFragmentState(@Nullable Bundle savedInstanceState) throws IllegalAccessException, NoSuchFieldException {
        Parcelable p;
    ...
    void performCreate(Bundle savedInstanceState) throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
    ...
    void performActivityCreated(Bundle savedInstanceState) throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
        }
        this.mState = 2;
    ...
    void performStart() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
    ...
    void performResume() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
            this.mChildFragmentManager.execPendingActions();
        }
    ...
    void performPause() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
    ...
    void performStop() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
    ...
    void performReallyStop() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
    ...
    void performDestroyView() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
    ...
    void performDestroy() throws IllegalAccessException, NoSuchFieldException {
        if (this.mChildFragmentManager != null) {
    ...
    void performDetach() throws IllegalAccessException, NoSuchFieldException {
        this.mCalled = false;
        onDetach();
        if (!this.mCalled) {
