...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    @Override // android.support.v4.app.FragmentManager
    public boolean executePendingTransactions() throws IllegalAccessException, NoSuchFieldException {
    ...
    @Override // android.support.v4.app.FragmentManager
    public boolean popBackStackImmediate(int id, int flags) throws IllegalAccessException, NoSuchFieldException {
        checkStateLoss();
        execPendingActions();
        if (id < 0) {
            throw new IllegalArgumentException("Bad id: " + id);
    ...
    private boolean popBackStackImmediate(String name, int id, int flags) throws IllegalAccessException, NoSuchFieldException {
        execPendingActions();
    ...
    private void setHWLayerAnimListenerIfAlpha(View v, Animation anim) throws IllegalAccessException, NoSuchFieldException {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    void moveToState(final android.support.v4.app.Fragment r18, int r19, int r20, int r21, boolean r22) {
        /*
    ...
    void completeShowHideFragment(Fragment fragment) throws IllegalAccessException, NoSuchFieldException {
    ...
    void moveFragmentToExpectedState(Fragment f) throws IllegalAccessException, NoSuchFieldException {
        if (f != null) {
    ...
    void moveToState(int newState, boolean always) throws IllegalAccessException, NoSuchFieldException {
    ...
    private void ensureExecReady(boolean allowStateLoss) throws IllegalAccessException, NoSuchFieldException {
        if (this.mExecutingActions) {
    ...
    public void execSingleAction(OpGenerator action, boolean allowStateLoss) throws IllegalAccessException, NoSuchFieldException {
    ...
    public boolean execPendingActions() throws IllegalAccessException, NoSuchFieldException {
        ensureExecReady(true);
    ...
    private void executePostponedTransaction(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) throws IllegalAccessException, NoSuchFieldException {
        int index;
        int index2;
    ...
    private void optimizeAndExecuteOps(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) throws IllegalAccessException, NoSuchFieldException {
        if (records != null && !records.isEmpty()) {
            ...
            while (recordNum < numRecords) {
                boolean canOptimize = records.get(recordNum).mAllowOptimization;
                if (!canOptimize) {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) throws IllegalAccessException, NoSuchFieldException {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex, ArraySet<Fragment> added) throws IllegalAccessException, NoSuchFieldException {
        int postponeIndex = endIndex;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void completeExecute(BackStackRecord record, boolean isPop, boolean runTransitions, boolean moveToState) throws IllegalAccessException, NoSuchFieldException {
    ...
    private static void executeOps(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) throws IllegalAccessException, NoSuchFieldException {
        int i = startIndex;
        while (i < endIndex) {
            BackStackRecord record = records.get(i);
            boolean isPop = isRecordPop.get(i).booleanValue();
    ...
    private void forcePostponedTransactions() throws IllegalAccessException, NoSuchFieldException {
        if (this.mPostponedTransactions != null) {
    ...
    private boolean generateOpsForPendingActions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isPop) {
        synchronized (this) {
            ...
            for (int i = 0; i < numActions; i++) {
                this.mPendingActions.get(i).generateOps(records, isPop);
            }
    ...
    Parcelable saveAllState() throws IllegalAccessException, NoSuchFieldException {
        int N;
        int N2;
        forcePostponedTransactions();
    ...
    public void dispatchCreate() throws IllegalAccessException, NoSuchFieldException {
        this.mStateSaved = false;
        this.mExecutingActions = true;
        moveToState(1, false);
        this.mExecutingActions = false;
    ...
    public void dispatchActivityCreated() throws IllegalAccessException, NoSuchFieldException {
        this.mStateSaved = false;
        this.mExecutingActions = true;
        moveToState(2, false);
        this.mExecutingActions = false;
    ...
    public void dispatchStart() throws IllegalAccessException, NoSuchFieldException {
        this.mStateSaved = false;
        this.mExecutingActions = true;
        moveToState(4, false);
        this.mExecutingActions = false;
    ...
    public void dispatchResume() throws IllegalAccessException, NoSuchFieldException {
        this.mStateSaved = false;
        this.mExecutingActions = true;
        moveToState(5, false);
        this.mExecutingActions = false;
    ...
    public void dispatchPause() throws IllegalAccessException, NoSuchFieldException {
        this.mExecutingActions = true;
        moveToState(4, false);
        this.mExecutingActions = false;
    }

    public void dispatchStop() throws IllegalAccessException, NoSuchFieldException {
        this.mStateSaved = true;
        this.mExecutingActions = true;
        moveToState(3, false);
        this.mExecutingActions = false;
    ...
    public void dispatchReallyStop() throws IllegalAccessException, NoSuchFieldException {
        this.mExecutingActions = true;
        moveToState(2, false);
        this.mExecutingActions = false;
    }

    public void dispatchDestroyView() throws IllegalAccessException, NoSuchFieldException {
        this.mExecutingActions = true;
        moveToState(1, false);
        this.mExecutingActions = false;
    }

    public void dispatchDestroy() throws IllegalAccessException, NoSuchFieldException {
    ...
    static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        public void completeTransaction() throws IllegalAccessException, NoSuchFieldException {
        ...
        public void cancelTransaction() throws IllegalAccessException, NoSuchFieldException {
