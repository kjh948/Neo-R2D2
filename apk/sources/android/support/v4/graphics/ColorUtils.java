...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int r, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int g, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int b, @NonNull float[] outHsl) {
        float h;
        float s;
        float rf = r / 255.0f;
        float gf = g / 255.0f;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int color, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int alpha) {
    ...
    public static void RGBToLAB(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int r, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int g, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int b, @NonNull double[] outLab) {
    ...
    public static void RGBToXYZ(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int r, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int g, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, to = 255) int b, @NonNull double[] outXyz) {
        if (outXyz.length != 3) {
