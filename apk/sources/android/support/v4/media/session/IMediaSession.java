        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    sendCommand(_arg08, _arg18, _arg2);
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg07 = (KeyEvent) KeyEvent.CREATOR.createFromParcel(data);
                    } else {
                        _arg07 = null;
                    }
                    boolean _result = sendMediaButton(_arg07);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    IMediaControllerCallback _arg09 = IMediaControllerCallback.Stub.asInterface(data.readStrongBinder());
                    registerCallbackListener(_arg09);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    IMediaControllerCallback _arg010 = IMediaControllerCallback.Stub.asInterface(data.readStrongBinder());
                    unregisterCallbackListener(_arg010);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 11:
                    ...
                    adjustVolume(_arg011, _arg19, _arg22);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setVolumeTo(_arg012, _arg110, _arg23);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    ...
                    playFromMediaId(_arg013, _arg14);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 26:
                    ...
                    sendCustomAction(_arg017, _arg1);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    prepareFromMediaId(_arg018, _arg17);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    prepareFromSearch(_arg019, _arg16);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 39:
                    ...
                    setRepeatMode(_arg020);
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg021 = data.readInt() != 0;
                    setShuffleModeEnabled(_arg021);
                    reply.writeNoException();
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
