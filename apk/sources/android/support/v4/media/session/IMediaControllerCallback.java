    ...
    public static abstract class Stub extends Binder implements IMediaControllerCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    List<MediaSessionCompat.QueueItem> _arg07 = data.createTypedArrayList(MediaSessionCompat.QueueItem.CREATOR);
                    onQueueChanged(_arg07);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 9:
                    ...
                    onRepeatModeChanged(_arg08);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg09 = data.readInt() != 0;
                    onShuffleModeChanged(_arg09);
                    return true;
                case 1598968902:
