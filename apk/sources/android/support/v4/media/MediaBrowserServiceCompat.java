        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), data.getBundle(MediaBrowserProtocol.DATA_SEARCH_EXTRAS), (ResultReceiver) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), MediaBrowserServiceCompat.this.new ServiceCallbacksCompat(msg.replyTo));
                    break;
                default:
        ...
        public void connect(final String pkg, final int uid, final Bundle rootHints, final ServiceCallbacks callbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                ...
                public void run() {
                    ...
                    ConnectionRecord connection = MediaBrowserServiceCompat.this.new ConnectionRecord();
                    connection.pkg = pkg;
