...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflaterFactory {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(android.support.v7.appcompat.R.layout.abc_dialog_title_material, (ViewGroup) null);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(android.support.v7.appcompat.R.layout.abc_screen_toolbar, (ViewGroup) null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(android.support.v7.appcompat.R.id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(android.support.v7.appcompat.R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(android.support.v7.appcompat.R.id.action_bar_activity_content);
    ...
    public View createView(View view, String name, @NonNull Context context, @NonNull AttributeSet attrs) {
        ...
        if (IS_PRE_LOLLIPOP) {
            if (attrs instanceof XmlPullParser) {
                ...
                inheritContext = shouldInheritContext((ViewParent) view);
            }
        }
